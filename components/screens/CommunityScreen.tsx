            ...
            <header className=''>
                <div className='flex items-center justify-between'>
                    <div className="flex gap-4 relative">
                        <Image className="absolute -top-7 rounded-full border-4 border-white" src="https://pbs.twimg.com/profile_images/1610648722542661635/Pcps1_zG_400x400.jpg" alt="fortys" width={96} height={96}/>
                        <div className="ml-28">
