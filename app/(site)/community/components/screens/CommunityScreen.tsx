...
const CommunityScreen = (community: ICommunity) => {
	...
	return (
		<section className={`${poppins.className} bg-secondary-dark p-6`}>
			<header className='workout flex flex-col grid-cols-2 gap-8 bg-secondary-light rounded-xl p-6'>
				...
				<p className={`text-md col-span-2 text-surface-light`}>
					Where fitness enthusiasts unite to support, inspire, and achieve
					collective wellness goals as a community.
				</p>
			</header>
