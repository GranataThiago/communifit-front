...
const buttonVariants: ButtonStyles = {
    filled: 'bg-primary text-white rounded-full w-full py-3 font-[500]',
    outlined: 'border border-primary text-white rounded-full w-full py-3 font-[500]',
    text: 'bg-transparent text-primary rounded-full w-full py-3 font-[500]'
}
